    ...
    <div id="aboutMeContent">
        ...
        <div id="aboutMeDiv">
            ...
            <p className='lineheight'>Jag har en examen i webbutveckling från Mittuniversitetet. Under programmets
                ...
                har gett mig mer självförtroende i att arbeta med olika metoder och anpassa mig till ett arbetssätt eller
                till de verktyg som ska användas. Genom det här arbetet har jag även blivit bekväm med att läsa dokumentation
                och lära mig därifrån. Projektuppgifterna har ofta gått ut på att ta fram fullskaliga webbapplikationer 
                vilket har hjälpt mig bli bekväm med att utveckla och ta fram allt självständigt. 
                Jag har dessutom läst kurser i grafisk teknik, projektledning och webbanvändbarhet, vilket har gett mig lite 
                ytterligare kunskaper runtomkring utvecklandet. I kursen om grafisk teknik fick jag testa olika redigeringsverktyg,
                experimentera med bildbehandling och arbeta med rörligt material vilket har varit väldigt användbart vid 
                framtagandet av webbplatser.  Webbanvändbarhetskursen har gett mig större förståelse för hur man 
                kan anpassa och bearbeta hemsidor för att kunna göra material tillgängligt för så många som möjligt. 
